...
- (void)setModel:(Model *)model {
    _model = model;
    // 转发
    [self setupBtnCount:model.reposts_count btn:self.repostBtn title:@"转发"];
    // 评论
    [self setupBtnCount:model.comments_count btn:self.commentBtn title:@"评论"];
    // 赞
    [self setupBtnCount:model.attitudes_count btn:self.attitudeBtn title:@"赞"];
}
